# This repo is a copy of [official TAP repo](https://github.com/ZhengyaoJiang/latentplanExtension). We extend the original code to discrete action space and Atari benchmark.
